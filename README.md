...
- 当前版本：SDK `1.0.1`，Demo `1.0.0`（minSdk `23`）
...
- [下载 SDK AAR](https://raw.githubusercontent.com/SaleSmartly-Mobile/Mobile-SDK/1.0.1/android/sdk/salesmartly-chatwidget-sdk-v1.0.1.aar)
